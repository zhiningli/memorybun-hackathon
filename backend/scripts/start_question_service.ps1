# PowerShell script to start Question Service
# Port: 8000
...
$serviceDir = Join-Path (Split-Path -Parent $scriptDir) "question_service"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Starting Question Service (Port $Port)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
# Start the service
Write-Host "`nStarting Question Service on port $Port..." -ForegroundColor Green
...
try {
    ...
    Pop-Location
    Write-Host "`nQuestion Service stopped." -ForegroundColor Yellow
}
