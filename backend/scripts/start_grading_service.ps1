# PowerShell script to start Grading Service
# Port: 8002
...
$serviceDir = Join-Path (Split-Path -Parent $scriptDir) "grading_service"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Starting Grading Service (Port $Port)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
# Start the service
Write-Host "`nStarting Grading Service on port $Port..." -ForegroundColor Green
...
try {
    ...
    Pop-Location
    Write-Host "`nGrading Service stopped." -ForegroundColor Yellow
}
